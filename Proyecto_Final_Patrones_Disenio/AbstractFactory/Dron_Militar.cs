...
{
    internal class Dron_Militar : IAeronave, IVisitableAeronave
    {
        ...
        {
            CantidadVuelos++;
            Console.WriteLine($"Dron Militar {Placa} realizando vigilancia táctica. Total vuelos: {CantidadVuelos}");
        }
